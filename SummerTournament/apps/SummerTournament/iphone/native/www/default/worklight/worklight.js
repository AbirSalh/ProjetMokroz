...
WL.Logger = (function (jQuery) {
  ...
  var __log = function (args, priority) {
    ...
    if (!__checkNativeEnvironment()) {
      ...
      // we use WL.StaticAppProps instead of WL.Client.getEnvironment because the former is
      // guaranteed to be available
      if (typeof console === 'object' && WL.StaticAppProps.ENVIRONMENT !== 'air' && WL.StaticAppProps.ENVIRONMENT !== 'blackberry10') {  // avoid infinite loop on Adobe AIR and BB10 
...
function MD5(a){function c(a,b){var d,c,e,g,f;e=a&2147483648;g=b&2147483648;d=a&1073741824;c=b&1073741824;f=(a&1073741823)+(b&1073741823);return d&c?f^2147483648^e^g:d|c?f&1073741824?f^3221225472^e^g:f^1073741824^e^g:f^e^g}function b(a,b,d,e,g,f,h){a=c(a,c(c(b&d|~b&e,g),h));return c(a<<f|a>>>32-f,b)}function e(a,b,d,e,g,f,h){a=c(a,c(c(b&e|d&~e,g),h));return c(a<<f|a>>>32-f,b)}function f(a,b,d,e,g,f,h){a=c(a,c(c(b^d^e,g),h));return c(a<<f|a>>>32-f,b)}function l(a,b,d,e,g,f,h){a=c(a,c(c(d^(b|~e),g),
h));return c(a<<f|a>>>32-f,b)}function k(a){var b,d,e=[];for(d=0;3>=d;d++)b=a>>>8*d&255,e=e.concat(b);return e}var d=[],m,o,p,q,g,i,h,j,d=function(a){var b,d=a.length;b=d+8;for(var e=16*((b-b%64)/64+1),c=[],g=0,f=0;f<d;)b=(f-f%4)/4,g=8*(f%4),c[b]|=a[f]<<g,f++;b=(f-f%4)/4;c[b]|=128<<8*(f%4);c[e-2]=d<<3;c[e-1]=d>>>29;return c}(a);g=1732584193;i=4023233417;h=2562383102;j=271733878;for(a=0;a<d.length;a+=16)m=g,o=i,p=h,q=j,g=b(g,i,h,j,d[a+0],7,3614090360),j=b(j,g,i,h,d[a+1],12,3905402710),h=b(h,j,g,i,
...
wl_directUpdateChallengeHandler.__defaultListener = {
		...
		onFinish: function(status){
			...
			else if (status=="CANCELED")
			{
				...
				WL.Client.__setConnectingState(false);
				wl_directUpdateChallengeHandler.submitFailure();
			}
...
WL.Trusteer = (function() {
	 ...
	 *
	 * @param onSuccess - A callback function invoked when Trusteer SDK is installed and risk assessment is available.
	 * @param onFailure - A callback function invoked when Trusteer SDK is not installed or Trusteer SDK failed to initialize (i.e. license)
	 *
